...
public class ThrowablePocketBubbleEntity extends ThrowableGrenadeEntity
{
    ...
    public ThrowablePocketBubbleEntity(EntityType<? extends ThrowableGrenadeEntity> entityType, Level worldIn)
    {
        super(entityType, worldIn);
    }

    public ThrowablePocketBubbleEntity(EntityType<? extends ThrowableGrenadeEntity> entityType, Level world, LivingEntity entity)
    {
    ...
    public ThrowablePocketBubbleEntity(Level world, LivingEntity entity)
    {
    ...
    {
        if (this.target != null) {
            PocketBubbleEntity.createBubble(this, null, new BlockPos(this.target.offset(0.5, 0, 0.5)));
        }
    }
    ...
    protected void onHit(HitResult result)
    {
        ...
        if (result.getType() == HitResult.Type.ENTITY) {
            ...
            this.target = new BlockPos(block.offset(0.5, 0, 0.5));
            this.remove(RemovalReason.KILLED);
            this.onDeath();
        }
    }
