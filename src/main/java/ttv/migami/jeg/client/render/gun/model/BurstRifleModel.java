 ...
 */
public class BurstRifleModel implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemDisplayContext transformType, ItemStack stack, ItemStack parent, LivingEntity entity, PoseStack matrixStack, MultiBufferSource buffer, int light, int overlay) {
        ...
        RenderUtil.renderModel(SpecialModels.BURST_RIFLE_MAIN.getModel(), stack, matrixStack, buffer, light, overlay);

        //Renders the iron sights if no scope is attached.
        if ((Gun.getScope(stack) == null))
            RenderUtil.renderModel(SpecialModels.BURST_RIFLE_IRON_SIGHTS.getModel(), stack, matrixStack, buffer, light, overlay);

        if (Gun.hasAttachmentEquipped(stack, IAttachment.Type.STOCK)) {

            if (Gun.getAttachment(IAttachment.Type.STOCK, stack).getItem() == ModItems.TACTICAL_STOCK.get())
                RenderUtil.renderModel(SpecialModels.BURST_RIFLE_STOCK_TACTICAL.getModel(), stack, matrixStack, buffer, light, overlay);
            else if (Gun.getAttachment(IAttachment.Type.STOCK, stack).getItem() == ModItems.LIGHT_STOCK.get())
                RenderUtil.renderModel(SpecialModels.BURST_RIFLE_STOCK_LIGHT.getModel(), stack, matrixStack, buffer, light, overlay);
        ...
        if ((Gun.hasAttachmentEquipped(stack, IAttachment.Type.MAGAZINE)))
        {
            ...
            if (Gun.getAttachment(IAttachment.Type.MAGAZINE, stack).getItem() == ModItems.DRUM_MAG.get())
                RenderUtil.renderModel(SpecialModels.BURST_RIFLE_MAGAZINE_DRUM.getModel(), stack, matrixStack, buffer, light, overlay);
        }
        else
        ...
        if (entity.equals(Minecraft.getInstance().player)) {
            ...
            RenderUtil.renderModel(SpecialModels.BURST_RIFLE_EJECTOR.getModel(), stack, matrixStack, buffer, light, overlay);
            //Always pop
            matrixStack.popPose();
