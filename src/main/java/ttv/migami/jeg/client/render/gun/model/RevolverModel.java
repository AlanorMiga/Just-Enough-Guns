...
{
    @Override
    public void render(float partialTicks, ItemTransforms.TransformType display, ItemStack stack, ItemStack parent, @Nullable LivingEntity entity, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay)
    {
