...
public class GunOptions
{
    ...
    /*public static final ProgressOption ADS_SENSITIVITY = new GunSliderPercentageOption("jeg.options.adsSensitivity", 0.0, 1.0, 0.01F, gameSettings -> {
        ...
        return new TranslatableComponent("jeg.options.adsSensitivity.format", FORMAT.format(adsSensitivity));
    });

    public static final CycleOption<ResourceLocation> CROSSHAIR = CycleOption.create("jeg.options.crosshair", () -> {
