...
public class ModEntityGeneration {
    ...
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToSpecificBiomes(event, ModEntities.GHOUL.get(),
                25, 4, 8, Biomes.DARK_FOREST, Biomes.BIRCH_FOREST, Biomes.OLD_GROWTH_BIRCH_FOREST, Biomes.TAIGA, Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA);
        addEntityToSpecificBiomes(event, ModEntities.BOO.get(),
                50, 1, 3, Biomes.FLOWER_FOREST, Biomes.DARK_FOREST);
    }
