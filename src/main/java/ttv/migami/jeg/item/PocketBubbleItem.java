...
public class PocketBubbleItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(new TranslatableComponent("info.jeg.pocket_bubble").withStyle(ChatFormatting.YELLOW));
        tooltip.add(new TranslatableComponent("info.jeg.tooltip_item.pocket_bubble").withStyle(ChatFormatting.GRAY));
    }
