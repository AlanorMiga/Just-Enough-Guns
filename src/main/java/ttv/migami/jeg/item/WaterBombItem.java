...
public class WaterBombItem extends AmmoItem
{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(new TranslatableComponent("info.jeg.water_bomb").withStyle(ChatFormatting.YELLOW));
        tooltip.add(new TranslatableComponent("info.jeg.tooltip_item" + "." + this.asItem()).withStyle(ChatFormatting.GRAY));
    }
