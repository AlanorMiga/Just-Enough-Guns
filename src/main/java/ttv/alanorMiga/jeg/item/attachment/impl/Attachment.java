...
public abstract class Attachment
{
    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachment<?>)
        {
            ...
            {
                event.getToolTip().add(Component.translatable("perk.jeg.title").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
    ...
    {
        components.add(Component.translatable(positive ? "perk.jeg.entry.positive" : "perk.jeg.entry.negative", Component.translatable(id, params).withStyle(ChatFormatting.WHITE)).withStyle(positive ? ChatFormatting.DARK_AQUA : ChatFormatting.GOLD));
    }
}
