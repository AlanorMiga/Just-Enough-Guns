...
public abstract class AbstractRecyclerMenu extends AbstractContainerMenu {
    ...
    protected AbstractRecyclerMenu(MenuType<?> p_38960_, RecipeType<? extends AbstractRecyclingRecipe> p_38961_, int p_38963_, Inventory p_38964_) {
        this(p_38960_, p_38961_, p_38963_, p_38964_, new SimpleContainer(3), new SimpleContainerData(4));
    }

    protected AbstractRecyclerMenu(MenuType<?> p_38966_, RecipeType<? extends AbstractRecyclingRecipe> p_38967_, int p_38969_, Inventory p_38970_, Container p_38971_, ContainerData p_38972_) {
    ...
    protected boolean canSmelt(ItemStack p_38978_) {
        return this.level.getRecipeManager().getRecipeFor((RecipeType<AbstractRecyclingRecipe>) this.recipeType, new SimpleContainer(p_38978_), this.level).isPresent();
    }
