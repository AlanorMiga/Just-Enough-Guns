...
public class ScrapWorkbenchContainer extends AbstractContainerMenu
{
    ...
    {
        super(ModContainers.SCRAP_WORKBENCH.get(), windowId);
        this.workbench = workbench;
        this.pos = workbench.getBlockPos();

        int offset = ScrapWorkbenchRecipes.isEmpty(workbench.getLevel()) ? 0 : 28;
    ...
    public ScrapWorkbenchBlockEntity getWorkbench()
    {
        return workbench;
    }
