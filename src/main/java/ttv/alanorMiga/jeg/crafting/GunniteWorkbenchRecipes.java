 ...
 * Author: MrCrayfish
 */
public class GunniteWorkbenchRecipes
{
    ...
    public static NonNullList<GunniteWorkbenchRecipe> getAll(Level world)
    {
        return world.getRecipeManager().getRecipes().stream()
                .filter(recipe -> recipe.getType() == ModRecipeTypes.GUNNITE_WORKBENCH.get())
