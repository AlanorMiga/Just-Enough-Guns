...
import ttv.alanorMiga.jeg.common.properties.SightAnimation;
...
public final class PropertyHelper
{
    ...
    public static final String MODEL_KEY = "jeg:model";
    public static final String WEAPON_KEY = "jeg:weapon";
    public static final String SCOPE_KEY = "jeg:scope";
    public static final String BARREL_KEY = "jeg:barrel";
