...
public class ScarLModel implements IOverrideModel {
    ...
    public void render(float partialTicks, TransformType transformType, ItemStack stack, ItemStack parent, LivingEntity entity, PoseStack matrixStack, MultiBufferSource buffer, int light, int overlay) {
        ...
        if ((Gun.getScope(stack) == null))
            RenderUtil.renderModel(SpecialModels.SCAR_L_IRON_SIGHTS.getModel(), stack, matrixStack, buffer, light, overlay);
        else
            RenderUtil.renderModel(SpecialModels.SCAR_L_FOLDED_IRON_SIGHTS.getModel(), stack, matrixStack, buffer, light, overlay);
